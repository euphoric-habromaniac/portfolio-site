      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 lg:col-start-1">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 scroll-fade-in scroll-delay-100" data-testid="heading-about">
          ...
          <div className="lg:col-span-6 lg:col-start-7 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-6 bg-card rounded-lg wabi-shadow hover-lift scroll-scale-up scroll-delay-400" data-testid="card-focus-areas">
              ...
              <div className="p-6 bg-card rounded-lg wabi-shadow hover-lift scroll-scale-up scroll-delay-500" data-testid="card-interests">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-2 h-8 bg-accent-primary/30 rounded-full"></div>

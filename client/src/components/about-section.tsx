        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 lg:col-start-7 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="cozy-card p-6 hover-lift scroll-scale-up scroll-delay-400" data-testid="card-focus-areas">
              ...
              <div className="cozy-card p-6 hover-lift scroll-scale-up scroll-delay-500" data-testid="card-interests">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-2 h-8 bg-accent-primary/30 rounded-full"></div>
